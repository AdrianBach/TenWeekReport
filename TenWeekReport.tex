...
At the beginning of what could be a new mass extinction episode (LACKS REF), preserving the remaining "Nature" is a central concern for humanity, as we undeniably depend on the services ecosystems provide. (no need for references, right?)
...
Conservation can be preventive, by establishing protected areas to preserve intact ecosystems from human impact \citep{vanwilgen2011critical, bainbridge2017goose}, or to restore already damage ecosystems \citep{rumpff2011state}. 
...
The systems conservation deals with are highly complex and densely interconnected, including ecology, sociology, agronomy and climatology simultaneously.
They exhibit most of the characteristics of wicked problems according to \cite{game2013conservation}: "\textit{numerous interacting elements lacking any central control, non-linear interactions between elements, constant change which is seldom reversible, and no clearly defined boundaries}".
...
Furthermore, management is most of the time based on estimations of populations, which accuracy varies according to the technique \citep{BUNNEFELD2011441}.
...
This inability to predict the system's response to a change in the conservation policy can result in a reluctance to change, and in the maintain of inadequate conservation policies \citep{peterson2005conservation, keith2011uncertainty}.
